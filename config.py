...
APP_ID = int(os.environ.get("APP_ID", "21868557")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "91668a524679e0f0aa79faca1bdb1ca1") #Your API Hash from my.telegram.org
#--------------------------------------------
...
OWNER_ID = int(os.environ.get("OWNER_ID", "6473376800")) # Owner id
#--------------------------------------------
PORT = os.environ.get("PORT", "8001")
#--------------------------------------------
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://lakshmilavanya1968:p0XoQ8UYFXuKkIbp@cluster0.qpkj46r.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0
")
